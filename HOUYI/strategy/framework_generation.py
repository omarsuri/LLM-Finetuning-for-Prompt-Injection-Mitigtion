...
@dataclasses.dataclass
class ProductReviewFrameworkGenerator(FrameworkGenerator):
    generator_name: str = "ProductReviewFrameworkGenerator"
    ...
    def generate_framework(self, application_document: str) -> str:
        ...
        logger.info(f"Generated product review framework: {chosen}")
        return chosen

FRAMEWORK_GENERATION_STRATEGY = [ProductReviewFrameworkGenerator, ShortAnswerFrameworkGenerator, PlainFrameworkGenerator]
